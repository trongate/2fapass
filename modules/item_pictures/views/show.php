...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('item_pictures/manage', 'View All Item Pictures', array("class" => "button alt"));
        echo anchor('item_pictures/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                ...
                <div class="row">
                    <div>URL Identifier String</div>
                    <div><?= $url_identifier_string ?></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('item_pictures/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete an Item Picture record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
